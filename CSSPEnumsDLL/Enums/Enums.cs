...
namespace CSSPEnumsDLL.Enums
{
    ...
    public enum ReportGenerateObjectsKeywordEnum
    {
        ...
        SUBSECTOR_MUNICIPALITY_MAP_INFRASTRUCTURE = 18,
        SUBSECTOR_MUNICIPALITY_CONTACTS = 19,
        SUBSECTOR_MUNICIPALITY_INFRASTRUCTURE_DETAIL = 20,
        SUBSECTOR_ECCC_AND_SWCP_LOGO = 21,
        SUBSECTOR_CSSP_LOGO = 22,
        SUBSECTOR_POLLUTION_SOURCE_SITES_COMPACT = 23,
        SUBSECTOR_LOCATION_OF_SURVEY_AREA_MAP = 24,
        SUBSECTOR_CURRENT_CLASSIFICATION_AND_SAMPLING_LOCATION_MAP = 25,
        SUBSECTOR_MUNICIPALITY_WWTP_COLLECTION_SYSTEM_MAP = 26,
        SUBSECTOR_RECOMMENDED_CLASSIFICATION_MAP = 27,
        SUBSECTOR_POLLUTION_SOURCE_LOCATIONS_MAP = 28,
    }
