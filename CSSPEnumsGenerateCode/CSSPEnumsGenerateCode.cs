...
namespace CSSPEnumsGenerateCode
{
    public partial class CSSPEnumsGenerateCode : Form
    {
        ...
        public void Generate_GeneratedClassEnumTextOrder_cs()
        {
            ...
            FileInfo fiDLL = new FileInfo(@"C:\CSSP latest code old\CSSPEnumsDLL\CSSPEnumsDLL\bin\Debug\CSSPEnumsDLL.dll");
            FileInfo fi = new FileInfo(@"C:\CSSP latest code old\CSSPEnumsDLL\CSSPEnumsDLL\Enums\GeneratedClassEnumTextOrder.cs");
        ...
        public void Generate_GeneratedBaseEnumsService_cs()
        {
            StringBuilder sb = new StringBuilder();
            FileInfo fiDLL = new FileInfo(@"C:\CSSP latest code old\CSSPEnumsDLL\CSSPEnumsDLL\bin\Debug\CSSPEnumsDLL.dll");
            FileInfo fi = new FileInfo(@"C:\CSSP latest code old\CSSPEnumsDLL\CSSPEnumsDLL\Services\GeneratedBaseEnumsService.cs");
        ...
        public void Generate_GeneratedBaseEnumServiceTest_cs()
        {
            StringBuilder sb = new StringBuilder();
            FileInfo fiDLL = new FileInfo(@"C:\CSSP latest code old\CSSPEnumsDLL\CSSPEnumsDLL\bin\Debug\CSSPEnumsDLL.dll");
            FileInfo fi = new FileInfo(@"C:\CSSP latest code old\CSSPEnumsDLL\CSSPEnumsDLL.Tests\Services\GeneratedBaseEnumServiceTest.cs");
